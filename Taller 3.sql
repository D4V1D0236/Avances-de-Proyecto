...
SELECT name FROM city WHERE district LIKE '%Aires%' AND name NOT LIKE
'%La Plata%';

SELECT UPPER(name) FROM city WHERE name LIKE '%a%' AND LENGTH(name) <= 22;

SELECT * FROM city WHERE LENGTH(LOWER(name)) - LENGTH(REPLACE (LOWER(name), 'a', '')) = 1 AND LENGTH(name) >= 22;
...
(
    ...
    LOWER(name) NOT LIKE '%e%' AND 
    LOWER(name) NOT LIKE '%i%' AND 
    LOWER(name) NOT LIKE '%o%' AND 
    LOWER(name) NOT LIKE '%u%'
)
OR
(
    LOWER(name) LIKE '%e%' AND 
    LOWER(name) NOT LIKE '%a%' AND 
    LOWER(name) NOT LIKE '%i%' AND 
    LOWER(name) NOT LIKE '%o%' AND 
    LOWER(name) NOT LIKE '%u%'
)
...
(
    ...
    LOWER(name) NOT LIKE '%e%' AND 
    LOWER(name) NOT LIKE '%i%' AND 
    LOWER(name) NOT LIKE '%o%'
);

SELECT name from city WHERE population > 5000000;

SELECT name FROM country ORDER BY indepyear DESC LIMIT 5;
SELECT name FROM country ORDER BY (Population/SurfaceArea) DESC LIMIT 5;
SELECT name FROM country WHERE(SurfaceArea < (SELECT AVG(SurfaceArea)/5 FROM country));
SELECT AVG(LifeExpectancy)FROM country;
SELECT name, Continent, Population FROM country
WHERE Population IN (SELECT MAX(Population)FROM country GROUP BY Continent) 
AND Continent IN ('Asia', 'Europe', 'Africa', 'Oceania', 'North America', 'South America');